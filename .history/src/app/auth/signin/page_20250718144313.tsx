  ...
  return (
    <main className="relative flex flex-col items-center justify-center min-h-[90vh] pt-32 pb-16 px-4 overflow-hidden">
      ...
      <form className="relative z-10 bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl border border-blue-400/30 p-10 w-full max-w-md flex flex-col gap-6">
        <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-blue-400 to-purple-500 animate-gradient-x mb-2 text-center">Sign In</h2>
        ...
        <button type="submit" className="mt-4 px-4 py-2 bg-gradient-to-r from-cyan-400 to-blue-500 text-white rounded-full shadow-lg hover:from-blue-500 hover:to-cyan-400 transition-all font-bold border border-blue-400/40 animate-glow">Sign In</button>
        <div className="text-sm text-center mt-2 text-cyan-200">
          Don&apos;t have an account? <a href="/auth/signup" className="text-cyan-300 hover:underline">Sign Up</a>
        </div>
      </form>
    </main>
  );
