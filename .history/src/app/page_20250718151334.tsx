...
export default function Home() {
  return (
    <main className="relative flex flex-col items-center justify-center min-h-[90vh] pt-32 pb-16 px-4 overflow-hidden bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700">
      ...
      {/* Feature Highlights */}
      <section className="relative z-10 w-full max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-10 mt-16 px-4">
