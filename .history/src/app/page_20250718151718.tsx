...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center min-h-[80vh] bg-white">
      <section className="w-full max-w-2xl mx-auto text-center py-20 px-4">
        ...
        <form className="w-full flex flex-col sm:flex-row items-center gap-3 mb-8">
          <input
            type="text"
      ...
      <section className="w-full max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 mt-12 px-4">
        <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 shadow-sm flex flex-col items-center">
