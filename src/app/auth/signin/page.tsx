export default function SignInPage() {
  return (
    <main className="flex flex-col items-center justify-center min-h-[90vh] bg-white pt-28 pb-16 px-2">
      <form className="bg-white border border-gray-200 rounded-3xl shadow-lg p-10 w-full max-w-screen-sm flex flex-col gap-6">
        <h2 className="text-3xl font-extrabold text-blue-900 mb-2 text-center">Sign In</h2>
        ...
        <button type="submit" className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-full shadow hover:bg-blue-700 transition-all font-bold">Sign In</button>
